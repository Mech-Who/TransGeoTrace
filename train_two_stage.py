...
parser.add_argument('--data-name', default='CVOGL_DroneAerial', type=str,
                    help='subset\'s name when dataset is cvogl, should be \'CVOGL_DroneAerial\' or \'CVOGL_SVI\'')

parser.add_argument('--split-name', default=None, type=str,
                    help='subset\'s name when dataset is cvogl after set data_name, should be \'train\' or \'test\' or \'val\'')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # MODIFY: two-stage 任务只需要 cvogl 数据集
    if args.dataset == 'cvogl':
        dataset = CVOGL
